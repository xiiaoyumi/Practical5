...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        else if(id == R.id.action_increase)
        {
            ...
            {
                Toast.makeText(getApplicationContext(), "This is the biggest size we have (Currently 48)", Toast.LENGTH_SHORT).show();
            }
        }
        else if(id == R.id.action_decrease)
        {
            ...
            {
                Toast.makeText(getApplicationContext(), "This is the smallest size we have (Currently 8)", Toast.LENGTH_SHORT).show();
            }
        }
